...
@gregsdennis has also started a separate [test suite](https://github.com/gregsdennis/json-schema-vocab-test-suites) for third-party vocabularies that is modelled after this suite.
